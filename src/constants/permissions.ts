// Frontend constants mirroring server/lib/permissions.ts
...
export function hasPermission(
  ...
  if (userPermissions & Permission.ADMIN) return true;
...
export function getAllowedNotificationTypes(permissions: number): number {
  ...
  if (canManageRequests) allowed |= 1;
